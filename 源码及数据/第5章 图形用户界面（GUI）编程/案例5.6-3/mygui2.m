...
%示例1
% global edit1_value  % 声明edit1_value为全局变量
% edit1_value=get(hObject,'string');%取得edit1中输入的数据，并赋值给
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%示例2
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%示例3
% edit1_value=get(hObject,'string');%取得edit1中输入的数据
% setappdata(handles.figure1,'mydata',edit1_value);  %设置应用程序数据
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%示例4
% edit1_value=get(hObject,'string');% 取得edit1中输入的数据
% set(handles.figure1,'UserData',edit1_value);  %设置figure1的userdata属性
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%示例5
edit1_value=get(hObject,'string');% 取得edit1中输入的数据
save('myfile.mat','edit1_value'); %保存edit1_value的值。
...
%示例1
% global edit1_value  % 声明edit1_value为全局变量
% set(handles.edit2,'string',edit1_value);	%在edit2中显示
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%示例2
% set(handles.edit2,'string',handles.edit1_value);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%示例3
% edit1_value=getappdata(handles.figure1,'mydata');	%取得edit1_value的数据
% set(handles.edit2,'string',edit1_value);	%在edit2中显示
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%示例4
% edit1_value=get (handles.figure1,'UserData');	%取得figure1的UserData属性值为。
% set(handles.edit2,'string',edit1_value);	%在edit2中显示
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%示例5
S=load('myfile.mat');	
