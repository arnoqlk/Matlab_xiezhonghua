...
% *****************************统计量**************************************
%% 求均值
score = xlsread('examp7_1_1.xls','Sheet1','G2:G52');
score = score(score > 0);
score_mean = mean(score)

%% 求方差和标准差
SS1 = var(score)      % 计算(17.3-1)式的方差
SS1 = var(score,0)    % 也是计算(17.3-1)式的方差
SS2 = var(score,1)    % 计算(17.3-2)式的方差
s1 = std(score)       % 计算(17.3-3)式的标准差
s1 = std(score,0)     % 也是计算(17.3-3)式的标准差
s2 = std(score,1)     % 计算(17.3-4)式的标准差
...
%% q-q图
banji = xlsread('examp7_1_1.xls','Sheet1','B2:B52');
score = xlsread('examp7_1_1.xls','Sheet1','G2:G52');
score = score(score > 0);
banji = banji(score > 0);
