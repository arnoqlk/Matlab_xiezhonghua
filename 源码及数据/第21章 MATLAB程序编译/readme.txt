    ...
    B. Set the path by doing one of the following:
        ...
        * Add the MCR directory to the environment variable by issuing 
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_libmyshared.sh 
...
3. Collect the following files, based on what you are deploying: 
    ...
    NOTE: libmyshared.ctf will be present only if you have chosen 
    ...
    All Platforms:
        * libmyshared.ctf (if present)(Component Technology File archive,
          platform-dependent on target machine)

    Windows:
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          installer)
        * libmyshared.exe (application created by MATLAB Compiler)

    UNIX:
        * MCRInstaller.bin (MATLAB Compiler Runtime installer)
        * libmyshared (application created by MATLAB Compiler)
        * run_libmyshared.sh (shell script that can be run to 
    ...
    All Platforms:
        ...
        * libmyshared.dll (shared library, file extension varies by 
          platform)
        * libmyshared.h (library header file)
    ...
    Windows:
        * libmyshared.ctf (if present)(Component Technology File archive, contains 
          compiled M-code)    
        * libmyshared.xml (documentation files)
        * libmyshared.pdb (program database file - if DEBUG option 
          selected)
        * libmyshared.dll (component assembly file)
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)
    ...
    Windows:
        * libmyshared.ctf (if present)(Component Technology File archive, contains 
          compiled M-code)
        * libmyshared_1_0.dll (COM component)
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)      
    ...
    All Platforms: 
        * libmyshared.jar (Java class files and compiled M-code)
    ...
    Windows:
        * libmyshared.ctf (if present)(Component Technology File archive, contains 
          compiled M-code)
        * libmyshared_1_0.dll (COM component)
        * libmyshared.xla (optionally created and placed in
