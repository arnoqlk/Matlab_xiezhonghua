 ...
 */
FARPROC WINAPI testDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = testDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = testDelayLoadWin32FailureHook;
#endif
