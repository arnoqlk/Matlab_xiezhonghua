 ...
 */
FARPROC WINAPI ex21_3_1DelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = ex21_3_1DelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = ex21_3_1DelayLoadWin32FailureHook;
#endif
